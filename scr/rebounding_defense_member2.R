...
ggsave("output/Blocks by Position.png", width = 8, height = 6)
# Steal by Position
ggplot(nba_data, aes(x = Pos, y = STL)) +
  geom_boxplot(fill = "lightcoral") +
  labs(title = "Steals by Position", x = "Position", y = "Steals per Game")
ggsave("output/Steals by Position.png", width = 8, height = 6)
