...
write.csv(team_stats, here::here("output/team_summary_stats.csv"), row.names = FALSE)
write.csv(top_scoring_teams, here::here("output/top_scoring_teams.csv"), row.names = FALSE)
write.csv(best_defensive_teams, here::here("output/best_defensive_teams.csv"), row.names = FALSE)
